...
// Point strictly to the local/production environment file
dotenv.config({ path: '.env.local' });

const db = neon(process.env.DATABASE_URL!);

const teamMembers = [
    { name: 'Zaid', role: 'Creative Director', email: 'zaid@rfrncs.in' },
    { name: 'Brendan', role: 'Head of Production', email: 'brendan@rfrncs.in' },
    { name: 'Pratik', role: 'Lead Developer', email: 'pratik@rfrncs.in' },
    { name: 'Vihaan', role: 'Automation Expert', email: 'vihaan@rfrncs.in' },
    { name: 'Aarav', role: 'New Hire - Business Dev', email: 'aarav@rfrncs.in' },
];
...
const demoLeads = [
    ...
    { companyName: 'Nykaa', poc: 'Falguni Nayar', value: 900000, status: 'Cold Lead', source: 'Website', assigned_to: 'Brendan' },
    ...
    { companyName: 'PharmEasy', poc: 'Dharmil Sheth', value: 950000, status: 'Hot Lead', source: 'Apollo', assigned_to: 'Brendan' },
    ...
    { companyName: 'Cred', poc: 'Kunal Shah', value: 1750000, status: 'Cold Lead', source: 'Website', assigned_to: 'Brendan' },
...
async function seedDemo() {
    console.log("🧹 Wiping production data (leads & team_members)...");
    ...
    try {
        ...
        console.log("\n🎯 Production database synchronized for demo!");
    } catch (error: any) {
